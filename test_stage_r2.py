...
def parse_args():
    ...
    parser.add_argument("--ref_image", type=str, default="/content/MusePose/assets/images/ref.png")
    parser.add_argument("--dw_video", type=str, default="/content/MusePose/assets/poses/align/img_ref_video_dance.mp4")
...
def main():
    ...
    handle_single(args.ref_image, args.dw_video)
